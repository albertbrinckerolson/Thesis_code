...
function main2()
    ...
    params = Dict(instances[1] => Dict("threshold" => 0.4, "choice_model" => test_choice, "partial" => false),
                instances[2] => Dict("threshold" => 0.3, "choice_model" => no_choice, "partial" => false), 
                instances[3] => Dict("threshold" => 0.3, "choice_model" => no_choice, "partial" => false))
    ...
    for instance in instances
        ...
        experiment05 = experiment_loop(10, "Gurobi", demand, instance, false,model_folder*stat_dict[instance], model_folder*dyn_dict[instance], params[instance]["threshold"], params[instance]["choice_model"], params[instance]["partial"])
        experiment05.format_2_row("experiment_EA_Snipe.csv", true)
