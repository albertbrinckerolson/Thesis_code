...
function main2()
    ...
    choice_models = [no_choice, test_choice, choose_10p_less, choose_5p_less]
    ...
    for instance in instances
        ...
        for choice_model in choice_models
            for threshold in thresholds
                experiment05 = experiment_loop(100.0,1.0, 3, "Gurobi", demand, instance, false,model_folder*stat_dict[instance], model_folder*dyn_dict[instance], threshold, choice_model, true)
                experiment05.format_2_row("partial_ea_SpDp.csv", true)
