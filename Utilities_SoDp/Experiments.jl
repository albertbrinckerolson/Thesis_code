...
function main2()
    ...
    for instance in instances
        ...
        for choice_model in choice_models
            for threshold in thresholds
                #experiment05 = experiment_loop(3, "Gurobi", demand, instance, false,model_folder*stat_dict[instance], model_folder*dyn_dict[instance], threshold, choice_model, false)
                #experiment05.format_2_row("experiment_static_inopt_dyn_EU3_2_4.csv", true)
                ...
                experiment05.format_2_row("experiment_static_inopt_dyn_partial_3max.csv", true)
            end
        end
    end
end
